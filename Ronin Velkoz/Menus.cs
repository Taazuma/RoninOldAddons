...
namespace RoninVelkoz
{
    internal class Menus
    {
        ...
        public static void CreateMenu()
        {
            ...
            MiscMenu.AddLabel("Ultimate Follower");
            MiscMenu.Add("Uultimate", new CheckBox("Use Ult Follower"));
            MiscMenu.AddLabel("Automatic Tear Stacker");
            MiscMenu.Add("Ustack", new CheckBox("Stack Mode"));
        ...
        public static bool GapCloserModee { get { return MiscMenu["Ugapc"].Cast<CheckBox>().CurrentValue; } }
        public static bool GapCloserUseE { get { return MiscMenu["Egapc"].Cast<CheckBox>().CurrentValue; } }
        public static bool StackMode { get { return MiscMenu["Ustack"].Cast<CheckBox>().CurrentValue; } }
        public static bool InterrupterMode { get { return MiscMenu["Uinterrupt"].Cast<CheckBox>().CurrentValue; } }
        public static bool InterrupterUseE { get { return MiscMenu["Einterrupt"].Cast<CheckBox>().CurrentValue; } }
