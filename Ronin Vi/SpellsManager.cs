...
namespace RoninVi
{
    public static class SpellsManager
    {
        ...
        */
        ...
        public static Spell.Chargeable Q2 { get; private set; }
        ...
        {
            Q2 = new Spell.Chargeable(SpellSlot.Q, 250, 875, 1250, 0, 1400, 55);
            Q = new Spell.Skillshot(SpellSlot.Q, 250, SkillShotType.Linear);
